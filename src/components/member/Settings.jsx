...
export default function Settings({ user, setInformation, accessToken, setShowChangePass }) {

  const [credentials, setCredentials] = useState([])
  return (
    <div className='flex flex-col gap-4 w-64 bg-white shadow-md p-2 absolute top-24 right-5 rounded-lg'>
