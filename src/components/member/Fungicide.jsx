...
export default function Fungicide({ user, accessToken, farms }) {
            ...
            <div className='flex justify-between px-5'>
                ...
                <div>
                    <button className='py-1 px-2 bg-teal-500 text-white flex gap-1 items-center hover:bg-teal-600 duration-200'
                        onClick={(e) => [setModalOpen(true), setType("FUNGICIDE")]}>
                        ...
                        !subsidies ? "" :
                            subsidies.map(subsidy => (
                                <tr className='text-center border-b-2 border-slate-200'>
                                    ...
                                    <td>{subsidy.status !== 'COMPLETED' ? '' : getDate(subsidy.received_date)}</td>    
