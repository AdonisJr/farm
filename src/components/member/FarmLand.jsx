...
import GmapWithPolygon from '../admin/GmapWithPolygon';
...
export default function FarmLand({ currentLocation, accessToken }) {
    ...
    return (
        <div className='w-full bg-white p-2 me-5'>
            ...
            <GmapWithPolygon currentLocation={currentLocation} accessToken={accessToken} apiKey={googleApi} farms={farms} setUpdate={setUpdate} update={update} />
        </div>
    )
}
