  ...
  return (
    <div className="flex flex-col fixed justify-between w-56 p-2 min-h-screen text-start gap-5 pt-10 bg-white text-slate-600 font-semibold">
      ...
      <div className="flex flex-col gap-5">
        ...
        <button
          className={`hover:bg-indigo-500 text-black hover:text-white duration-200 p-2 rounded-t-sm ${activePage === "Assistance" ? "text-white bg-indigo-500" : "text-black"
            } duration-200`}
          onClick={() => handleActivePage("Assistance")}
        >
          Assistance
        </button>
        <button
          className={`hover:bg-indigo-500 text-black hover:text-white duration-200 p-2 rounded-t-sm ${activePage === "Certificates" ? "text-white bg-indigo-500" : "text-black"
            } duration-200`}
          onClick={() => handleActivePage("Certificates")}
        >
          Certificates
        </button>
        <button
          className={`hover:bg-indigo-500 text-black hover:text-white duration-200 p-2 rounded-t-sm ${activePage === "Announcements" ? "text-white bg-indigo-500" : "text-black"
            } duration-200`}
